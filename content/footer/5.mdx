      ...
      <div className="grid gap-16 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="lg:col-span-1">
          <div className="flex items-center mb-8">
            ...
            <span className="ml-3 text-xl font-light text-gray-900 tracking-wide">Minimal</span>
          </div>
          <p className="text-gray-500 text-sm leading-relaxed mb-8 max-w-xs">
            Clean solutions for a better tomorrow.
          </p>
          
          {/* Newsletter */}
          <div>
            <h4 className="text-sm font-medium text-gray-900 mb-4">Newsletter</h4>
            <div className="flex border border-gray-200 rounded-lg overflow-hidden">
              ...
              />
              <button className="px-4 py-3 text-gray-400 hover:text-gray-600 transition-colors">
        ...
        {/* Product */}
        <div>
          <h3 className="text-xs font-medium text-gray-400 mb-6 uppercase tracking-widest">Product</h3>
          <ul className="space-y-4">
            ...
            <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Updates</a></li>
        ...
        {/* Company */}
        <div>
          <h3 className="text-xs font-medium text-gray-400 mb-6 uppercase tracking-widest">Company</h3>
          <ul className="space-y-4">
        ...
        {/* Support */}
        <div>
          <h3 className="text-xs font-medium text-gray-400 mb-6 uppercase tracking-widest">Support</h3>
          <ul className="space-y-4">
